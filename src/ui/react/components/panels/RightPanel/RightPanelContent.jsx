...
function PlaceholderContent({ tabId }) {
    ...
    return (
        <div className="right-panel-content__placeholder">
            {Icon && (
                <div
                    className="right-panel-content__placeholder-icon"
                    data-color={tabConfig?.color}
                >
                    <Icon size={32} />
                </div>
            )}
            <div className="right-panel-content__placeholder-title">
                {tabConfig?.label || 'Unknown'}
            </div>
            <div className="right-panel-content__placeholder-text">
