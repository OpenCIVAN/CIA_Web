...
const QUICK_LAYOUTS = [
    { id: 'single', label: 'Single', icon: IconMaximize, rows: 1, cols: 1 },
    { id: 'side-by-side', label: 'Side by Side', icon: ViewWeekOutlined, rows: 1, cols: 2 },
    { id: 'stacked', label: 'Stacked', icon: ViewStreamOutlined, rows: 2, cols: 1 },
    { id: '2x2', label: '2×2 Grid', icon: IconGrid3x3, rows: 2, cols: 2 },
];
        ...
        return (
            <div className={`layout-tab layout-tab--loading ${className}`}>
                <div className="panel-header panel-header--green">
                    <IconLayoutGrid size={14} className="panel-header__icon" />
        ...
        <div className={`layout-tab ${className}`}>
            ...
            <div className="layout-tab__content">
                ...
                <div className="layout-tab__card" data-color="green">
                    <div className="layout-tab__card-header">
                        <AddCircleOutlineOutlined size={10} />
