...
function findWasmBinary() {
  return locateFile('vtkWasmApp.wasm');
}
...
var ASM_CONSTS = {
  1941840: ($0, $1) => { findCanvasEventTarget($0).style.cursor = $1 ? 'default' : 'none'; }
};

// Imports from the Wasm binary.
var _ProcessVTP = Module['_ProcessVTP'] = makeInvalidEarlyAccess('_ProcessVTP');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ProcessVTP'] != 'undefined', 'missing Wasm export: ProcessVTP');
  _ProcessVTP = Module['_ProcessVTP'] = createExportWrapper('ProcessVTP', 3);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = VtkWasmApp;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = VtkWasmApp;
